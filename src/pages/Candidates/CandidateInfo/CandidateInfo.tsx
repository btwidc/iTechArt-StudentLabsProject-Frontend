...
import CandidateInfoRow from './CandidateInfoRow/CandidateInfoRow';
...
const Candidates = () => {
  ...
  const candidate = candidatesList?.find(candidate => candidate.id.toString() === id);
  ...
  useEffect(() => {
    ...
    return (
      <div className="candidate-info-container">
        ...
        <CandidateInfoRow labelName="Technolohy:" rowInfo={candidate?.technology} />
      </div>
    );
};
